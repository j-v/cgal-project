...
public class MDSVis extends PApplet {
...
float text_size = 2.0f;
float quadsize = 2.00f;
float stretch = 4.0f;
...
//  String filename = dataPath(img_path + "\\" + NAMES_AND_POINTS_3D_FILE);
  ...
  {
    colors[i] = color(100.0f/ (float) num_classes * (float)i, 100, 100);
  }
...
//  print("\n");
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "MDSVis" };
    if (passedArgs != null) {
